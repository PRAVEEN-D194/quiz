...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
    ...
    <p>
        ...
        try {
            ...
            console.log(`[Register] Welcome email sent successfully to ${user.email}`);
        } catch (emailError) {
            console.error(`[Register] Welcome email failed to send to ${user.email}:`, emailError.message);
        }
